...
const CategoriesPage = () => (
  <div className="container mx-auto px-4 py-8">
    <h1 className="font-display text-3xl md:text-4xl font-extrabold text-center mb-2">Book Categories</h1>
    <p className="text-muted-foreground text-center mb-10">Pick a genre and start reading 📚</p>
