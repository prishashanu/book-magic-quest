...
const AboutPage = () => (
  <div className="container mx-auto px-4 py-8 max-w-2xl">
    <div className="text-center mb-10">
      ...
      <h1 className="font-display text-4xl md:text-5xl font-bold mb-2">About Page Peek</h1>
      <p className="text-sm text-muted-foreground">A cozy corner of the internet for readers who love books.</p>
    </div>

    <div className="space-y-5">
      <div className="bg-card rounded-xl border border-border p-6">
        <h2 className="font-display text-2xl font-bold mb-2">What is Page Peek?</h2>
      ...
      <div className="bg-card rounded-xl border border-border p-6">
        <h2 className="font-display text-2xl font-bold mb-2">Why we built this</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <div className="bg-cream/60 rounded-xl border border-border p-6 flex items-start gap-4">
        ...
        <div>
          <p className="font-display text-2xl font-bold mb-1">Meet Paige</p>
          <p className="text-sm text-muted-foreground leading-relaxed">
