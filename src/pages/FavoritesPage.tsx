...
const FavoritesPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="font-display text-3xl md:text-4xl font-bold text-center mb-2">💖 My Favorites</h1>
      ...
      {favBooks.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-muted-foreground mb-4">Start browsing and tap the heart to save books you love.</p>
